                            ...
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= url('/') ?>/pelabuhan/tambahPajak&RetribusiDaerah" method="post">
                                            {{csrf_field()}}
                        ...
                        <div class="card-body table-responsive p-0" style="height: auto;">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <!-- Detail Pelabuhan -->
                                        <a href="<?= url('/') ?>/pelabuhan/detailPajak&RetribusiDaerah/{{$pajak->id}}" class="btn btn-sm bg-gradient-primary"><i class="fas fa-pen-alt"></i></a>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?= url('/') ?>/pelabuhan/hapusPajak&RetribusiDaerah/{{$pajak->id}}"><button type="submit" class="btn bg-gradient-danger">Yes</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
