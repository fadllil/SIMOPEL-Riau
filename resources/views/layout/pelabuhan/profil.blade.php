...
@section('container')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Profil Pelabuhan</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Pelabuhan</a></li>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$pelabuhan['nama_pelabuhan']}}" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Posisi Koordinat</label>
                                        <input type="text" class="form-control" value="{{$pelabuhan['posisi_pelabuhan']}}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- textarea -->
                                    <div class="form-group">
                                        <label>Alamat Pelabuhan</label>
                                        <textarea class="form-control" rows="3" placeholder="{{$pelabuhan['alamat_pelabuhan']}}" disabled></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-2">
                                    <button type="button" class="btn btn-block bg-gradient-primary" data-toggle="modal" data-target="#editPelabuhan{{$pelabuhan['id']}}"><i class="fas fa-edit"> Edit</i></button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="modal fade" id="editPelabuhan{{$pelabuhan['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalScrollableTitle">Edit Pelabuhan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editPelabuhan/{{$pelabuhan->id}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label>Nama Pelabuhan</label>
    ...
    <div class="modal fade" id="editPerencanaan{{$perencanaan['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editPerencanaan/{{$perencanaan->id}}" method="post">
                        {{csrf_field()}}
    ...
    <div class="modal fade" id="editFasilitasDarat{{$fasilitas_darat['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editFasilitasDarat/{{$fasilitas_darat->id}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
    ...
    <div class="modal fade" id="editFasilitasPerairan{{$fasilitas_perairan['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editFasilitasPerairan/{{$fasilitas_perairan->id}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label>Type</label>
                            <div class="input-group mb-3">
    ...
    <div class="modal fade" id="editFasilitasDLKRDLKP{{$fasilitas_sarana['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editFasilitasDLKRDLKP/{{$fasilitas_sarana->id}}" method="post">
                        {{csrf_field()}}
    ...
    <div class="modal fade" id="editFasilitasPeralatan{{$fasilitas_peralatan['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editFasilitasPeralatan/{{$fasilitas_peralatan->id}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
    ...
    <div class="modal fade" id="editFasilitasSarana{{$fasilitas_sarana['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editFasilitasSarana/{{$fasilitas_sarana->id}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
