                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <a href="<?= url('/') ?>/pelabuhan/pdfPajak&RetribusiDaerah/{{$pajak_list->id}}">
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editPajak&RetribusiDaerah/{{$pajak_list->id}}/0" method="post">
                        {{csrf_field()}}
    ...
    <div class="modal fade" id="editBiaya" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editPajak&RetribusiDaerah/{{$pajak_list->id}}/1" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label>Labuh Kapal</label>
                            <div class="input-group mb-3">
    ...
    <div class="modal fade" id="editKeterangan" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= url('/') ?>/pelabuhan/editPajak&RetribusiDaerah/{{$pajak_list->id}}/2" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label>Labuh Kapal</label>
                            <div class="input-group mb-3">
