                                ...
                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= url('/') ?>/pelabuhan/tambahBongkarMuatPelabuhan" method="post">
                                                {{csrf_field()}}
                            ...
                            <div class="modal fade" id="cetakPDFBulanan" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= url('/') ?>/pelabuhan/cetakPDFBulananBongkarMuat" method="post" >
                                                {{csrf_field()}}
                                                <div class="form-group">
                            ...
                            <div class="modal fade" id="cetakPDFTahunan" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= url('/') ?>/pelabuhan/cetakPDFTahunanBongkarMuat" method="post" >
                                                {{csrf_field()}}
                                                <div class="form-group">
                                                    <label>Tahun</label>
                                                    <div class="input-group date">
                                        ...
                                        <div class="modal fade" id="editBongkarMuat{{$bongkarmuat->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= url('/') ?>/pelabuhan/editBongkarMuatPelabuhan/{{$bongkarmuat->id}}" method="post">
                                                            {{csrf_field()}}
                                                            <div class="form-group">
                                                                <label>Nama Perusahaan</label>
                                                                <div class="input-group mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Penumpang Turun (Orang)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_b_pt" type="text" class="form-control" value="{{$bongkarmuat->adn_b_pt}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Hewan (Ekor)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_b_hewan" type="text" class="form-control" value="{{$bongkarmuat->adn_b_hewan}}" required>
                                                                </div>
                                                            </div>
                                                            <label>Jenis Muatan</label>
                                                            <div class="form-group">
                                                                <label>Peti Kemas</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_b_peti" type="text" class="form-control" value="{{$bongkarmuat->adn_b_peti}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Jumlah</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_b_jumlah" type="text" class="form-control" value="{{$bongkarmuat->adn_b_jumlah}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Barang</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_b_barang" type="text" class="form-control" value="{{$bongkarmuat->adn_b_barang}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Volume (Ton/M3)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_b_volume" type="text" class="form-control" value="{{$bongkarmuat->adn_b_volume}}" required>
                                                                </div>
                                                            </div>
                                                            <label>Muat</label>
                                                            <label>Waktu Muat</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Penumpang Naik (Orang)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_m_pn" type="text" class="form-control" value="{{$bongkarmuat->adn_m_pn}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Hewan (Ekor)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_m_hewan" type="text" class="form-control" value="{{$bongkarmuat->adn_m_hewan}}" required>
                                                                </div>
                                                            </div>
                                                            <label>Jenis Muatan</label>
                                                            <div class="form-group">
                                                                <label>Peti Kemas</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_m_peti" type="text" class="form-control" value="{{$bongkarmuat->adn_m_peti}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Jumlah</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_m_jumlah" type="text" class="form-control" value="{{$bongkarmuat->adn_m_jumlah}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Barang</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_m_barang" type="text" class="form-control" value="{{$bongkarmuat->adn_m_barang}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Volume (Ton/M3)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="adn_m_volume" type="text" class="form-control" value="{{$bongkarmuat->adn_m_volume}}" required>
                                                                </div>
                                                            </div>
                                                            <!-- / Angkutan Dalam Negeri -->
                                                            ...
                                                            <div class="form-group">
                                                                <label>Penumpang Turun (Orang)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_b_pt" type="text" class="form-control" value="{{$bongkarmuat->aln_b_pt}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Hewan (Ekor)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_b_hewan" type="text" class="form-control" value="{{$bongkarmuat->aln_b_hewan}}" required>
                                                                </div>
                                                            </div>
                                                            <label>Jenis Muatan</label>
                                                            <div class="form-group">
                                                                <label>Peti Kemas</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_b_peti" type="text" class="form-control" value="{{$bongkarmuat->aln_b_peti}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Jumlah</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_b_jumlah" type="text" class="form-control" value="{{$bongkarmuat->aln_b_jumlah}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Barang</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_b_barang" type="text" class="form-control" value="{{$bongkarmuat->aln_b_barang}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Volume (Ton/M3)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_b_volume" type="text" class="form-control" value="{{$bongkarmuat->aln_b_volume}}" required>
                                                                </div>
                                                            </div>
                                                            <label>Muat</label>
                                                            <label>Waktu Muat</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Penumpang Naik (Orang)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_m_pn" type="text" class="form-control" value="{{$bongkarmuat->aln_m_pn}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Hewan (Ekor)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_m_hewan" type="text" class="form-control" value="{{$bongkarmuat->aln_m_hewan}}" required>
                                                                </div>
                                                            </div>
                                                            <label>Jenis Muatan</label>
                                                            <div class="form-group">
                                                                <label>Peti Kemas</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_m_peti" type="text" class="form-control" value="{{$bongkarmuat->aln_m_peti}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Jumlah</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_m_jumlah" type="text" class="form-control" value="{{$bongkarmuat->aln_m_jumlah}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Barang</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_m_barang" type="text" class="form-control" value="{{$bongkarmuat->aln_m_barang}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Volume (Ton/M3)</label>
                                                                <div class="input-group mb-3">
                                                                    <input name="aln_m_volume" type="text" class="form-control" value="{{$bongkarmuat->aln_m_volume}}" required>
                                                                </div>
                                                            </div>
                                                            <!-- / Angkutan Luar Negeri -->
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?= url('/') ?>/pelabuhan/hapusBongkarMuatPelabuhan/{{$bongkarmuat->id}}"><button type="submit" class="btn bg-gradient-danger">Yes</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
