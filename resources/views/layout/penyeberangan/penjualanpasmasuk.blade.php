@section('title')
    SIMOPEL-Riau | Penjualan Pas Masuk
@endsection
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Penjualan Pas Masuk</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Penjualan Pas Masuk</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="<?= url('/') ?>/penyeberangan/tambahPenjualanPasMasuk" method="post">
                                            {{csrf_field()}}
                        ...
                        <div class="card-body table-responsive p-0" style="height: auto;">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <?php
                                    $tgl = \Carbon\Carbon::parse($penjualan->tanggal)->format('D');
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="<?= url('/') ?>/penyeberangan/detailPenjualanPasMasuk/{{$penjualan->id}}" class="btn btn-sm bg-gradient-primary"><i class="fas fa-pen-alt"></i></a>
                                        <!-- Hapus Pajak Dan Retribusi Daerah -->
                                        <a href="#" class="btn btn-sm bg-gradient-danger" data-toggle="modal" data-target="#hapusPajakRetribusiDaerah{{$penjualan->id}}"><i class="fas fa-trash"></i></a>
                                        <div class="modal fade" id="hapusPajakRetribusiDaerah{{$penjualan->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable" role="document" style="text-align : left;">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalScrollableTitle">Anda yakin ingin menghapus data Penjualan Pas Masuk?</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?= url('/') ?>/penyeberangan/hapusPenjualanPasMasuk/{{$penjualan->id}}"><button type="submit" class="btn bg-gradient-danger">Yes</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
