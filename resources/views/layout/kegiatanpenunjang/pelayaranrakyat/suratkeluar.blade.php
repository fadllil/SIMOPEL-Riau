                            ...
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= url('/') ?>/kegiatanpenunjang/pelayaranrakyat/tambahSurat" method="post" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?= url('/') ?>/kegiatanpenunjang/pelayaranrakyat/hapusSurat/{{$surat->id}}"><button type="submit" class="btn bg-gradient-danger">Yes</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Hapus Pelayaran Rakyat -->
