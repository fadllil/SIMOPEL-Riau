        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="<?=url('/')?>/kegiatanpenunjang/pelayaranrakyat/home" class="{{ Request::is ('kegiatanpenunjang/pelayaranrakyat/home') ? 'active' : '' }} nav-link">
                    ...
                    <li class="nav-item">
                        <a href="<?=url('/')?>/kegiatanpenunjang/pelayaranrakyat/profil" class="{{ Request::is ('kegiatanpenunjang/pelayaranrakyat/profil') ? 'active' : '' }} nav-link">
                ...
                Request::is ('kegiatanpenunjang/perla') ? 'menu-open' : ''
                }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?=url('/')?>/kegiatanpenunjang/perla" class="nav-link {{ Request::is ('kegiatanpenunjang/perla') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Perjalanan Kapal</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item has-treeview {{
                        Request::is ('kegiatanpenunjang/pelayaranrakyat/suratMasuk') ? 'menu-open' : '' ||
                        Request::is ('kegiatanpenunjang/pelayaranrakyat/suratKeluar') ? 'menu-open' : ''
                        }}">
                        <a href="#" class="nav-link">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?=url('/')?>/kegiatanpenunjang/pelayaranrakyat/suratMasuk" class="nav-link {{ Request::is ('kegiatanpenunjang/pelayaranrakyat/suratMasuk') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Surat Masuk</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?=url('/')?>/kegiatanpenunjang/pelayaranrakyat/suratKeluar" class="nav-link {{ Request::is ('kegiatanpenunjang/pelayaranrakyat/suratKeluar') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Surat Keluar</p>
                                </a>
                            </li>
...
<?php if ((Request::is ('kegiatanpenunjang/pelayaranrakyat/home')) == true){ ?>
<script>
    $(function () {
