        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="<?=url('/')?>/kegiatanpenunjang/pengurusantransportasi/home" class="{{ Request::is ('kegiatanpenunjang/pengurusantransportasi/home') ? 'active' : '' }} nav-link">
                    ...
                    <li class="nav-item">
                        <a href="<?=url('/')?>/kegiatanpenunjang/pengurusantransportasi/profil" class="{{ Request::is ('kegiatanpenunjang/pengurusantransportasi/profil') ? 'active' : '' }} nav-link">
                ...
                Request::is ('kegiatanpenunjang/pengurusantransportasi') ? 'menu-open' : ''
                }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?=url('/')?>/kegiatanpenunjang/pengurusantransportasi" class="nav-link {{ Request::is ('kegiatanpenunjang/pengurusantransportasi') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Pengurusan Transportasi</p>
                                </a>
                            </li>
                        </ul>
                    </li>
