  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a href="#" class="d-block">Admin Simopel-Riau</a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{
                Request::is ('admin/admin') ? 'menu-open' : '' ||
                Request::is ('admin/pelabuhan') ? 'menu-open' : '' ||
                Request::is ('admin/penyeberangan') ? 'menu-open' : '' ||
                Request::is ('admin/tukstersus') ? 'menu-open' : '' ||
                Request::is ('admin/kegiatanpenunjang') ? 'menu-open' : ''
                }}">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?=url('/')?>/admin/admin" class="nav-link {{ Request::is ('admin/admin') ? 'active' : ''}}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Admin</p>
                    </a>
                </li>
              <li class="nav-item">
                <a href="<?=url('/')?>/admin/pelabuhan" class="nav-link {{ Request::is ('admin/pelabuhan') ? 'active' : ''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pelabuhan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=url('/')?>/admin/penyeberangan" class="nav-link {{ Request::is ('admin/penyeberangan') ? 'active' : ''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Penyeberangan</p>
                </a>
              </li>
                <li class="nav-item">
                    <a href="<?=url('/')?>/admin/tukstersus" class="nav-link {{ Request::is ('admin/tukstersus') ? 'active' : ''}}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Tuks/Tersus</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?=url('/')?>/admin/kegiatanpenunjang" class="nav-link {{ Request::is ('admin/kegiatanpenunjang') ? 'active' : ''}}">
                        <i class="far fa-circle nav-icon"></i>
