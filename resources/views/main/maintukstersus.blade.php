    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    <a href="#" class="d-block">Admin Tuks/Tersus</a>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="<?=url('/')?>/tukstersus/home" class="{{ Request::is ('tukstersus/home') ? 'active' : '' }} nav-link">
                    ...
                    <li class="nav-item">
                        <a href="<?=url('/')?>/tukstersus/profil" class="{{ Request::is ('tukstersus/profil') ? 'active' : '' }} nav-link">
                ...
                Request::is ('tukstersus/operasional') ? 'menu-open' : '' ||
                Request::is ('tukstersus/bongkarmuat') ? 'menu-open' : '' ||
                Request::is ('tukstersus/sewaperairan') ? 'menu-open' : ''
                }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?=url('/')?>/tukstersus/operasional" class="nav-link {{ Request::is ('tukstersus/operasional') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Operasional</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?=url('/')?>/tukstersus/bongkarmuat" class="nav-link {{ Request::is ('tukstersus/bongkarmuat') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Bongkar Muat</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?=url('/')?>/tukstersus/sewaperairan" class="nav-link {{ Request::is ('tukstersus/sewaperairan') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Sewa Perairan Tuks Tersus</p>
                                </a>
                            </li>
                        </ul>
                    </li>
